...
Inledningsvis; beskrivning från TailorStore.se säger att "frackskjortan ska vara en vit bomullsskjorta med piképanel framtill som stärker upp. Kragen är alltid en styvt uppfälld snibbkrage (vingkrage). Spetsarna kan vila över flugan eller sitta mer modernt, precis bakom." Kommentar: I KFV finns det ännu ingen uttalad klädregel kring var snibbarna skall vila men generellt i KFVs sammanhang bäres snibbarna oftast, men inte alltid, bakom flugans vingar.

För den extra krispiga känslan på skjortbröstet rekommenderas att använda klassikern "Spraystärk" eller motsv.

Vidare bör man försäkra sig om att skjortan är tillräckligt lång och går så pass långt ner längs kroppen för att i möjligaste mån inte hasa upp och exponera huden vid byxlinningen. Ex.vis om man sätter sig ner eller böjer sig ner för att knyta sina skor.

#### Knäppning och manschetterknappar

Dessa bör i KFVs strävan efter att vara det lilla extra från en svunnen tid, förr, då det var bättre, väljas sådan skjorta som har löstagbara bröstknappar. Manschetterna efter eget val och smak. Det skall nämnas att det finns frackskjortor med vanliga skjortknappar. I KFV bör sådana skjortmodeller undvikas. Om man vill leta efter det lilla extra så kan en skjorta med s.k. Napoleon-ficka vara användbart då denna öppning möjliggör att montera de lösa bröstknapparna lättare.
...
3. Bild på bandet med kardborr och snyggt fixade ändar.
...
Lyran är den genomgående symbolen för alla uppsaliensiska akademikragar - oberoende av fakultet. Lyran lär ursprungligen vara en symbol för Uppsala universitet då den är en erkänd symbol för klassisk bildning. Ursprungligen är symboliken lånad från Apollons attribut - som avbildas bärande en lyra.

Apollon var konstens, diktens och vetenskapens gud och ska därför representera i detta sammanhang all högre utbildning vid universitetet. I sällskapet KFV syns också detta i utdelandet av artes-tecken för den broder som utmärkt sig för konsterna. Här dock i en snävare kontext än vad universitetet ursprungligen menat att symbolisera med lyran. [Bild på kragen och artestecken sida vid sida]

De tre första graderna omhuldas lyran av lagerblad där studentkragen har ett sparsamt kransverk som sen växer med studentens kunskap och examensnivå. På docent- och professorskragen växer kransverket ytterligare men varvas istället med lagerblad och ekbland. Även detta är hämtat från den militära heraldiken där ekbladen symboliserar styrka och stabilitet.
...
Några ord från Jakob Sidenvall om sommar resp vintermodell på Uppsalamössan.

#### Doktorshatten

Ytterligare några ord från HBD Bandstein, RKFV.

*Bärandet av Doktorshatt
Efter att en doctor iuvenis mottagit sin doktorshatt och klivit ner från parnassen bär denne tre symboler: diplomet förseglat med universitetets sigill, guldringen som symboliserar trohet mot vetenskapen och doktorshatten.
...
Efter detta brukas doktorshatten inomhus endast vid doktorspromotioner. Som huvudbonad för utomhusbruk kan den dock mer frekvent komma till användning i kombination med högtidsdräkt. Dvs när en annan person skulle ha hög hatt.

Dessutom bars doktorshatten förr till begravning för att hedra den avlidne men det har blivit alltmer sällsynt, men då även till mörk kostym.
Doktorshatt bäres ej till militär uniform.
